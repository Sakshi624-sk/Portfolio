...
const frontTextContainer = document.querySelector(".frontText");
const frontImgContainer = document.querySelector(".frontImg");
const authorNameContainer = document.querySelector(".name");
const JobContainers = document.querySelectorAll(".JobContainer");
...
window.addEventListener("scroll",()=>{
    ...
    frontTextContainer.style.transform = `translateY(${offsetY * 0.1}px)`
    frontImgContainer.style.transform = `translate(${offsetY * 0.4}px)`
    authorNameContainer.style.transform = `translateX(${offsetY * 0.1}px)`
    JobContainers[0].style.backgroundPositionY = `${offsetY * 0.5}px`
    JobContainers[1].style.backgroundPositionY = `${-offsetY * 0.5}px`
    ...
    phones[1].style.transform = `translate(calc(750vh - ${offsetY}px))`
})